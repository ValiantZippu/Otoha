...
import ua.syt0r.kanji.presentation.screen.main.screen.home.screen.letters_dashboard.use_case.LettersDashboardUpdateDeckArchivedUseCase
...
val lettersDashboardScreenModule = module {
    ...
    factory<LettersDashboardScreenContract.UpdateDeckArchivedUseCase> {
        LettersDashboardUpdateDeckArchivedUseCase(
            repository = get()
        )
    }
